      ...
      <div className="footer-content">
        ...
        <div className="footer-section">
          ...
          <div className="footer-links">
            ...
            <a href="leetcode.com/u/SatyamMIshra62" target="_blank" rel="noreferrer" className="tooltip">
              <SiLeetcode className="icon leetcode" />
              <span className="tooltip-text">LeetCode</span>
            </a>
            <a href="https://x.com/satyamkmishraa" target="_blank" rel="noreferrer" className="tooltip">
